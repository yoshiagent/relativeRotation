...
def main():
    ...
    pairs = [
        ...
        ("P06", "自行車",      "9921", "巨大",       "9914", "美利達",     "✓", "2026-05-20", "巨大vs美利達"),
        ("P07", "精密傳動",    "2049", "上銀",       "4576", "大銀微系統", "✓", "2026-05-20", "上銀vs大銀微系統"),
        ("P08", "DRAM/記憶體", "2408", "南亞科",     "2344", "華邦電",     "✓", "2026-05-20", "南亞科vs華邦電"),
    ]
    ...
    stocks = [
        ...
        ("9921", "9921.TW",  "巨大",       "其他",       "自行車",      "上市", "2026-05-20"),
        ("9914", "9914.TW",  "美利達",     "其他",       "自行車",      "上市", "2026-05-20"),
        ("2049", "2049.TW",  "上銀",       "電機機械",   "精密傳動",    "上市", "2026-05-20"),
        ("4576", "4576.TW",  "大銀微系統", "電機機械",   "精密傳動",    "上市", "2026-05-20"),
        ("2408", "2408.TW",  "南亞科",     "半導體",     "DRAM/記憶體", "上市", "2026-05-20"),
        ("2344", "2344.TW",  "華邦電",     "半導體",     "DRAM/記憶體", "上市", "2026-05-20"),
